...
// Pass 0
//--------------------------------------------------------------//
string wall_Pass_0_Model : ModelData = "..\\..\\..\\..\\..\\..\\..\\..\\Program Files\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\Sphere.3ds";
...
VS_OUTPUT wall_Pass_0_Vertex_Shader_vs_main( VS_INPUT Input )
{
   VS_OUTPUT Output;
...
float4 wall_Pass_0_Pixel_Shader_ps_main( PS_INPUT Input ) : COLOR0
{
...
//--------------------------------------------------------------//
// Technique Section for wall
//--------------------------------------------------------------//
technique wall
{
   pass Pass_0
   {
      VertexShader = compile vs_1_1 wall_Pass_0_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 wall_Pass_0_Pixel_Shader_ps_main();
   }
