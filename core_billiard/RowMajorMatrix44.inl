...
//----------------------------------------------------------------------------
template <class Real>
RowMajorMatrix44<Real>::RowMajorMatrix44 (bool bZero)
{
    if (bZero)
    {
        MakeZero();
...
//----------------------------------------------------------------------------
template <class Real>
RowMajorMatrix44<Real>::RowMajorMatrix44 (const RowMajorMatrix44& rkM)
{
...
//----------------------------------------------------------------------------
template <class Real>
RowMajorMatrix44<Real>::RowMajorMatrix44 (Real fM00, Real fM01, Real fM02, Real fM03,
...
//----------------------------------------------------------------------------
template <class Real>
RowMajorMatrix44<Real>::RowMajorMatrix44 (const Real afEntry[16], bool bRowMajor)
{
    if (bRowMajor)
    {
...
//----------------------------------------------------------------------------
template <class Real>
inline RowMajorMatrix44<Real>::operator const Real* () const
{
    return m_afEntry;
}
//----------------------------------------------------------------------------
template <class Real>
inline RowMajorMatrix44<Real>::operator Real* ()
{
    return m_afEntry;
}
//----------------------------------------------------------------------------
template <class Real>
inline const Real* RowMajorMatrix44<Real>::operator[] (int iRow) const
{
    return &m_afEntry[4*iRow];
}
//----------------------------------------------------------------------------
template <class Real>
inline Real* RowMajorMatrix44<Real>::operator[] (int iRow)
{
    return &m_afEntry[4*iRow];
}
//----------------------------------------------------------------------------
template <class Real>
inline Real RowMajorMatrix44<Real>::operator() (int iRow, int iCol) const
{
    return m_afEntry[iCol+4*iRow];
}
//----------------------------------------------------------------------------
template <class Real>
inline Real& RowMajorMatrix44<Real>::operator() (int iRow, int iCol)
{
    return m_afEntry[iCol+4*iRow];
}
//----------------------------------------------------------------------------
template <class Real>
void RowMajorMatrix44<Real>::MakeZero ()
{
...
//----------------------------------------------------------------------------
template <class Real>
void RowMajorMatrix44<Real>::MakeIdentity ()
{
...
//----------------------------------------------------------------------------
//template <class Real>
//void RowMajorMatrix44<Real>::SetRow (int iRow, const Vector4<Real>& rkV)
//{
...
//----------------------------------------------------------------------------
//template <class Real>
//Vector4<Real> RowMajorMatrix44<Real>::GetRow (int iRow) const
//{
//    int i0 = 4*iRow, i1 = i0+1, i2 = i1+1, i3 = i2+1;
...
//----------------------------------------------------------------------------
//template <class Real>
//void RowMajorMatrix44<Real>::SetColumn (int iCol, const Vector4<Real>& rkV)
//{
...
//----------------------------------------------------------------------------
//template <class Real>
//Vector4<Real> RowMajorMatrix44<Real>::GetColumn (int iCol) const
//{
...
//----------------------------------------------------------------------------
template <class Real>
void RowMajorMatrix44<Real>::GetColumnMajor (Real* afCMajor) const
{
...
//----------------------------------------------------------------------------
template <class Real>
inline RowMajorMatrix44<Real>& RowMajorMatrix44<Real>::operator= (const RowMajorMatrix44& rkM)
{
    m_afEntry[ 0] = rkM.m_afEntry[ 0];
    m_afEntry[ 1] = rkM.m_afEntry[ 1];
    m_afEntry[ 2] = rkM.m_afEntry[ 2];
...
//----------------------------------------------------------------------------
template <class Real>
int RowMajorMatrix44<Real>::CompareArrays (const RowMajorMatrix44& rkM) const
{
    return memcmp(m_afEntry,rkM.m_afEntry,16*sizeof(Real));
}
//----------------------------------------------------------------------------
template <class Real>
bool RowMajorMatrix44<Real>::operator== (const RowMajorMatrix44& rkM) const
{
...
//----------------------------------------------------------------------------
template <class Real>
inline RowMajorMatrix44<Real> RowMajorMatrix44<Real>::operator+ (const RowMajorMatrix44& rkM) const
{
    return RowMajorMatrix44<Real>(
        m_afEntry[ 0] + rkM.m_afEntry[ 0],
        m_afEntry[ 1] + rkM.m_afEntry[ 1],
        m_afEntry[ 2] + rkM.m_afEntry[ 2],
        m_afEntry[ 3] + rkM.m_afEntry[ 3],
...
//----------------------------------------------------------------------------
template <class Real>
inline RowMajorMatrix44<Real> RowMajorMatrix44<Real>::operator* (Real fScalar) const
{
    return RowMajorMatrix44<Real>(
        fScalar*m_afEntry[ 0],
        fScalar*m_afEntry[ 1],
...
//----------------------------------------------------------------------------
template <class Real>
inline RowMajorMatrix44<Real> RowMajorMatrix44<Real>::operator- () const
{
    return RowMajorMatrix44<Real>(
        -m_afEntry[ 0],
        -m_afEntry[ 1],
...
//----------------------------------------------------------------------------
template <class Real>
inline RowMajorMatrix44<Real>& RowMajorMatrix44<Real>::operator*= (Real fScalar)
{
    m_afEntry[ 0] *= fScalar;
    m_afEntry[ 1] *= fScalar;
    m_afEntry[ 2] *= fScalar;
...
//----------------------------------------------------------------------------
//template <class Real>
//inline Vector4<Real> RowMajorMatrix44<Real>::operator* (const Vector4<Real>& rkV) const
//{
//    return Vector4<Real>(
//        m_afEntry[ 0]*rkV[0] +
//        m_afEntry[ 1]*rkV[1] +
...
//----------------------------------------------------------------------------
template <class Real>
RowMajorMatrix44<Real> RowMajorMatrix44<Real>::Transpose () const
{
    return RowMajorMatrix44<Real>(
        m_afEntry[ 0],
        m_afEntry[ 4],
...
//----------------------------------------------------------------------------
template <class Real>
RowMajorMatrix44<Real> RowMajorMatrix44<Real>::TransposeTimes (const RowMajorMatrix44& rkM) const
{
    // P = A^T*B
    return RowMajorMatrix44<Real>(
        m_afEntry[ 0]*rkM.m_afEntry[ 0] +
...
//----------------------------------------------------------------------------
template <class Real>
RowMajorMatrix44<Real> RowMajorMatrix44<Real>::TimesTranspose (const RowMajorMatrix44& rkM) const
{
    // P = A*B^T
    return RowMajorMatrix44<Real>(
        m_afEntry[ 0]*rkM.m_afEntry[ 0] +
...
//----------------------------------------------------------------------------
template <class Real>
RowMajorMatrix44<Real> RowMajorMatrix44<Real>::Inverse () const
{
    ...
    {
        return RowMajorMatrix44<Real>::ZERO;
    }

    RowMajorMatrix44 kInv;
    kInv.m_afEntry[ 0] =
...
//----------------------------------------------------------------------------
template <class Real>
RowMajorMatrix44<Real> RowMajorMatrix44<Real>::Adjoint () const
{
    Real fA0 = m_afEntry[ 0]*m_afEntry[ 5] - m_afEntry[ 1]*m_afEntry[ 4];
    Real fA1 = m_afEntry[ 0]*m_afEntry[ 6] - m_afEntry[ 2]*m_afEntry[ 4];
    Real fA2 = m_afEntry[ 0]*m_afEntry[ 7] - m_afEntry[ 3]*m_afEntry[ 4];
...
//----------------------------------------------------------------------------
template <class Real>
Real RowMajorMatrix44<Real>::Determinant () const
{
    Real fA0 = m_afEntry[ 0]*m_afEntry[ 5] - m_afEntry[ 1]*m_afEntry[ 4];
    Real fA1 = m_afEntry[ 0]*m_afEntry[ 6] - m_afEntry[ 2]*m_afEntry[ 4];
    Real fA2 = m_afEntry[ 0]*m_afEntry[ 7] - m_afEntry[ 3]*m_afEntry[ 4];
...
//----------------------------------------------------------------------------
//template <class Real>
//Real RowMajorMatrix44<Real>::QForm (const Vector4<Real>& rkU,
...
//----------------------------------------------------------------------------
//template <class Real>
//void RowMajorMatrix44<Real>::MakeObliqueProjection (const Vector3<Real>& rkNormal,
...
//----------------------------------------------------------------------------
//template <class Real>
//void RowMajorMatrix44<Real>::MakePerspectiveProjection (const Vector3<Real>& rkNormal,
...
//----------------------------------------------------------------------------
//template <class Real>
//void RowMajorMatrix44<Real>::MakeReflection (const Vector3<Real>& rkNormal,
