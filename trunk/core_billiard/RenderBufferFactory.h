...
public:
    ...
    virtual IndexBuffer * createIndexBuffer_static( size_t numberOfIndex, unsigned short * indexies ) = 0;
    virtual IndexBuffer * createIndexBuffer_dynamic( size_t numberOfIndex, unsigned short * indexies ) = 0;
    virtual IndexBuffer * createIndexBuffer_stream( size_t numberOfIndex, unsigned short * indexies ) = 0;
