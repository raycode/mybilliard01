...
// Pass 0
//--------------------------------------------------------------//
string ball_10_Pass_0_Model : ModelData = "..\\..\\..\\..\\..\\..\\..\\..\\Program Files\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\Sphere.3ds";
...
VS_OUTPUT ball_10_Pass_0_Vertex_Shader_vs_main( VS_INPUT Input )
{
   VS_OUTPUT Output;
...
texture base_Tex
<
   string ResourceName = "..\\textures\\poolb10.dds";
>;
...
float4 ball_10_Pass_0_Pixel_Shader_ps_main( PS_INPUT Input ) : COLOR0
{
...
//--------------------------------------------------------------//
// Technique Section for ball 10
//--------------------------------------------------------------//
technique ball_10
{
   pass Pass_0
   {
      VertexShader = compile vs_1_1 ball_10_Pass_0_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 ball_10_Pass_0_Pixel_Shader_ps_main();
   }
