...
// Pass 0
//--------------------------------------------------------------//
string ball_5_Pass_0_Model : ModelData = "..\\..\\..\\..\\..\\..\\..\\..\\Program Files\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\Sphere.3ds";
...
VS_OUTPUT ball_5_Pass_0_Vertex_Shader_vs_main( VS_INPUT Input )
{
   VS_OUTPUT Output;
...
<
   ...
   bool UIVisible =  true;
> = float4( 0.25, 0.25, 0.25, 1.00 );
float4 fvSpecular
<
   string UIName = "fvSpecular";
   string UIWidget = "Color";
   bool UIVisible =  true;
> = float4( 0.66, 0.66, 0.66, 1.00 );
float4 fvDiffuse
<
   string UIName = "fvDiffuse";
   string UIWidget = "Color";
   bool UIVisible =  true;
> = float4( 0.90, 0.89, 0.85, 1.00 );
...
texture base_Tex
<
   string ResourceName = "..\\textures\\poolb5.dds";
>;
...
float4 ball_5_Pass_0_Pixel_Shader_ps_main( PS_INPUT Input ) : COLOR0
{
...
//--------------------------------------------------------------//
// Technique Section for ball 5
//--------------------------------------------------------------//
technique ball_5
{
   pass Pass_0
   {
      VertexShader = compile vs_1_1 ball_5_Pass_0_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 ball_5_Pass_0_Pixel_Shader_ps_main();
   }
