...
// Pass 0
//--------------------------------------------------------------//
string ball_3_Pass_0_Model : ModelData = "..\\..\\..\\..\\..\\..\\..\\..\\Program Files\\AMD\\RenderMonkey 1.82\\Examples\\Media\\Models\\Sphere.3ds";
...
VS_OUTPUT ball_3_Pass_0_Vertex_Shader_vs_main( VS_INPUT Input )
{
   VS_OUTPUT Output;
...
<
   ...
   bool UIVisible =  true;
> = float4( 0.20, 0.20, 0.20, 1.00 );
float4 fvSpecular
<
   string UIName = "fvSpecular";
   string UIWidget = "Color";
   bool UIVisible =  true;
> = float4( 0.53, 0.52, 0.52, 1.00 );
float4 fvDiffuse
<
   string UIName = "fvDiffuse";
   string UIWidget = "Color";
   bool UIVisible =  true;
> = float4( 0.68, 0.68, 0.65, 1.00 );
...
texture base_Tex
<
   string ResourceName = "..\\textures\\poolb3.dds";
>;
...
float4 ball_3_Pass_0_Pixel_Shader_ps_main( PS_INPUT Input ) : COLOR0
{
...
//--------------------------------------------------------------//
// Technique Section for ball 3
//--------------------------------------------------------------//
technique ball_3
{
   pass Pass_0
   {
      VertexShader = compile vs_1_1 ball_3_Pass_0_Vertex_Shader_vs_main();
      PixelShader = compile ps_2_0 ball_3_Pass_0_Pixel_Shader_ps_main();
   }
